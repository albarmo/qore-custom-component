...
export default registerComponent('Online Appointment', {
  ...
  Component: (props) => {
    ...
    async function sendEmail(appointment) {
      ...
      try {
        const { data } = await client.project.axios({
          method: 'post',
          url: `https://staging-qore-pipeline-teacher-593643.qore.dev/api/workflow/3d3f1a3e-7705-45d7-b603-7af4ff6c1784/instance/0b763128-61af-4645-a9db-5ccc3d6cc8bd/inbound`,
          headers: {
            'User-Agent':
            ...
            Referer:
              'https://staging-qore-pipeline-teacher-593643.qore.dev/workflows/3d3f1a3e-7705-45d7-b603-7af4ff6c1784',
    ...
    const displayedSlotOption = React.useMemo(() => {
      ...
      return sortedSlots
    }, [slots, serviceId, serviceData, selectedDate, petId, servicePlaceId])
    ...
    return (
      <>
        <Modal isOpen={isOpen} onClose={handleClose} size="xs" isCentered>
          <ModalOverlay />
          <ModalContent height="auto" pt="10px" pb="10px">
            <ModalCloseButton />
            <ModalBody>
